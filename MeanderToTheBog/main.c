...
int main(void)
{
    ...
    printf("oh no!!!\n");sleepPlease(4);
    printf("That is the bog of doom\n");
    interrupt();sleepPlease(3); //fake pause
    ...
    if (answer == 0)
    {
        ...
        if(answer == 1)
        {
            ...
            printf("you cease your adventuring and head home\n");sleepPlease(1);
            printf("to your loving wife and children to cherish the ever precious time you share\n");sleepPlease(3);
    ...
    switch (answer)
    {
        ...
        case(2):
        {
            ...
            printf("You became Ogre Soup!!!");sleepPlease(6);
            replay();
            return 0;
            break;
        }
        default:
        {
            printf("Congratulations, you broke the game.. Or did you?");sleepPlease(3);
            replay();
            return 0;
        }
    }
